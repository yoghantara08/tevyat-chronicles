...
const WeaponAscension: React.FC<{
  filteredWeaponAscension: IWeaponAscension[];
}> = ({ filteredWeaponAscension }) => {
  return (
    <>
      {filteredWeaponAscension.map((ascension: IWeaponAscension) => (
        <div key={ascension.id} className="py-3 px-4 text-lg flex space-x-3">
          <Image
